...
export default function NavUser() {
    ...
    const handleListMenu = () => {
        dispatch(navReducer({isNavList: 'opacity-100 md:animate-sideList'}))
    }


    return(
        <div className={'md:absolute bottom-0 flex items-center justify-center md:w-full'}>
            <div className={'font-montserratThin text-white  md:w-full md:px-2 md:py-4 rounded flex items-center  '}>
